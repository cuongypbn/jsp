...
public class Admin_controller extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            if (service.equalsIgnoreCase("hd_display")) {

                
                String sql = "select *  from Bill_coffe";
...
//                        BillDetail bd=new BillDetail(rs.getString(1),rs.getInt(11),rs.getFloat(12),rs.getInt(13), rs.getString(14));
                        vector.add(bill);
//                        billDetails.add(bd);
                    }
...
//                   request.setAttribute("bill", vector);
                 ...
                 ss.setAttribute("modal", md);
                  ...
                  RequestDispatcher rd = request.getServletContext().getRequestDispatcher("/admin/data.jsp");
//                  RequestDispatcher rd = request.getServletContext().getRequestDispatcher("/admin/index.jsp");
                  rd.forward(request, response);
